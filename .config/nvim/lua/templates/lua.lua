...
local function lspconfig_template(relative_path, filename)
	return [[
...
local function templates_template(relative_path, filename)
	return [=[
local utils = require("new-file-template.utils")
...
return function(opts)
	local template = {
		{ pattern = "lua/templates/.*", content = templates_template },
